    ...
    fileReader.onload = function() {
        ...
        for (var i = 0; i < lineList.length; i++) {
            if (lineList[i].startsWith("VER")) {
                ...
                newCard.content.querySelector("#logIcon").innerHTML = String("<i class=\"fas fa-info-circle\"></i>");
                ...
                newCard.content.querySelector("#logIcon").innerHTML = String("<i class=\"fas fa-arrow-alt-circle-up\"></i>");
                ...
                var line = lineList[i].split(" ");
                var newCard = document.querySelector("#template-card-desc");
                newCard.content.querySelector("#logIcon").innerHTML = String("<i class=\"fas fa-check-square\"></i>");
                newCard.content.querySelector("#logTitle").innerHTML = String("[" + line[1] + "] " + line[2] + ", " + line[3]);
                ...
                var line = lineList[i].split(" ");
                var newCard = document.querySelector("#template-card-desc");
                newCard.content.querySelector("#logIcon").innerHTML = String("<i class=\"fas fa-bug\"></i>");
                newCard.content.querySelector("#logTitle").innerHTML = String("[" + line[1] + "] " + line[2] + ", " + line[3]);
                var reportDesc = "";
                if (line.length > 5) {
                    reportDesc = line[5];
                ...
                var line = lineList[i].split(" ");
                var newCard = document.querySelector("#template-card-desc");
                newCard.content.querySelector("#logIcon").innerHTML = String("<i class=\"fas fa-exclamation-triangle\"></i>");
                newCard.content.querySelector("#logTitle").innerHTML = String("[" + line[1] + "] " + line[2] + ", " + line[3]);
                var warningDesc = "";
                if (line.length > 4) {
                    warningDesc = line[4];
